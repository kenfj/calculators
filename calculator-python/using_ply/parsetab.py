...
_lr_productions = [
  ...
  ('expression -> expression MULTIPLY expression','expression',3,'p_expression','calc.py',75),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression','calc.py',76),
  ('expression -> expression PLUS expression','expression',3,'p_expression','calc.py',77),
  ('expression -> expression MINUS expression','expression',3,'p_expression','calc.py',78),
  ('expression -> INT','expression',1,'p_expression_int_float','calc.py',84),
  ('expression -> FLOAT','expression',1,'p_expression_int_float','calc.py',85),
  ('expression -> NAME','expression',1,'p_expression_var','calc.py',91),
